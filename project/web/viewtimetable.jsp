...
<html>
<head>
    <title>View Timetable - College Notice Board</title>
    <meta charset="UTF-8">
...
<div class="sidebar">
    ...
    <a href="addtimetable.jsp"><i class="bi bi-calendar3"></i> Add Timetable</a>
    <a href="viewtimetable.jsp"><i class="bi bi-table"></i> View Timetable</a>
    <a href="alogout.jsp"><i class="bi bi-box-arrow-right"></i> Logout</a>
</div>

<!-- Main Content -->
<div class="main-content">
    <h3 class="text-center mb-4">📄 Exam Timetable</h3>
        ...
        <div class="col-md-6">
            <div class="card card-custom">
                <div class="card-header">
                    <i class="bi bi-calendar-event"></i> <%= rs.getString("exam") %> - <%= rs.getString("subject") %>
                </div>
                <div class="card-body">
                    <p><strong>Department:</strong> <%= rs.getString("dept_code") %></p>
                    <p><strong>Date:</strong> <%= rs.getString("exam_date") %></p>
                    <p><strong>Time:</strong> <%= rs.getString("exam_time") %></p>
                </div>
            </div>
        </div>
        <%
